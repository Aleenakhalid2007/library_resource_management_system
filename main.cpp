...
void rateBook(LibraryManager& lib, Member* member)
{
    ...
    if (InputHelper::askConfirmation("Would you like to add a review?")) {
        ...
        // In real implementation, would call lib.addReview(resourceID, member->getUserID(), rating, reviewText);
...
void handleMemberAction(LibraryManager& lib, UserManager& um, User* user, int choice)
{
    ...
    if (choice == 12) {
        payFines(um, dynamic_cast<Member*>(user));
        return;
    }
                    ...
                    if (user->getRole() == "Member") {
                        ...
                        if (member) {
                            ...
                            if (member->getBalance() > 0) {
                                ...
                                cout << "  Outstanding Fines: Rs. " << -member->getBalance() << "\n";
                            }
                        }
                    }
                    ...
                    if (user->getRole() == "Member") {
                        ...
                        do {
                            ...
                            if (member) {
                                ...
                                if (balance > 0) cout << " (Credit)";
                                else if (balance < 0) cout << " (Outstanding Fines)";
                                cout << "\n";
                            }
                            cout << "\n=========================================\n";
                            ...
                            cout << "  12. Pay Fines\n";
                            cout << "  13. Add Funds\n";
                            cout << "  14. Reserve Resource\n";
                            cout << "\n  0. Logout\n";
                            cout << "=========================================\n";
                            mChoice = InputHelper::readMenuChoice("Enter your choice: ", 0, 14);
                                            ...
                                            if (amChoice == 1) {
                                                ...
                                                if (amChoice == 3) {
                                                    ...
                                                    if (targetAdmin && targetAdmin->hasSuperAdminPrivilege()) {
                                                        cout << "\n⚠️  WARNING: You cannot delete the Super Admin!\n";
